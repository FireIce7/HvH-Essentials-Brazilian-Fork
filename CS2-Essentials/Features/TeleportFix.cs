...
public class TeleportFix
{
    ...
    public HookResult RunCommand(DynamicHook h)
    {
        ...
        Server.PrintToChatAll($"{ChatUtils.FormatMessage(_plugin.Config.ChatPrefix)} {ChatColors.Red}{player.PlayerName}{ChatColors.Default} tentou usar {ChatColors.Red}{feature}{ChatColors.Default}!");
