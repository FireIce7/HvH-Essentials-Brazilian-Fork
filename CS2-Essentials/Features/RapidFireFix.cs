...
public class RapidFire
{
    ...
    public HookResult OnWeaponFire(EventWeaponFire eventWeaponFire, GameEventInfo info)
    {
        ...
        Console.WriteLine($"[Pitu] Detected rapid fire from {eventWeaponFire.Userid.PlayerName}");
        ...
        // warn player
        Server.PrintToChatAll($"{ChatUtils.FormatMessage(_plugin.Config.ChatPrefix)} {ChatColors.Red}{eventWeaponFire.Userid.PlayerName}{ChatColors.Default} tentou usar {ChatColors.Red}double tap{ChatColors.Default}!");
