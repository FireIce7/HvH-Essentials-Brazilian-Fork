...
public class FriendlyFire
{
    ...
    public static readonly FakeConVar<bool> hvh_unmatched_friendlyfire = new("hvh_unmatched_friendlyfire", "Habilita fogo amigo apenas de utilitários (granadas, molotov)", true, ConVarFlags.FCVAR_REPLICATED);
    ...
    public HookResult OnTakeDamage(DynamicHook hook)
    {
        ...
        Console.WriteLine("[Pitu] Blocked friendly fire");
