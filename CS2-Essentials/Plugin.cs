...
{
    public override string ModuleName => "Pitu HvH - Essentials";
    public override string ModuleVersion => "2.0.0";
    public override string ModuleAuthor => "Pitu (based on HvH.gg by imi-tat0r)";
    public override string ModuleDescription => "Essential features for CS2 servers";
    ...
    public override void Load(bool hotReload)
    {
        ...
        Console.WriteLine("[Pitu] Start loading Pitu HvH - Essentials plugin");
        ...
        Console.WriteLine("[Pitu] Finished loading Pitu HvH - Essentials plugin");
    }
    ...
    public override void OnAllPluginsLoaded(bool hotReload)
    {
        ...
        {
            Console.WriteLine("[Pitu] CS2-CustomVotes plugin not found. Custom votes will not be registered.");
            return;
        }
        
        _isCustomVotesLoaded = true;
        Console.WriteLine("[Pitu] Registering custom votes");
    ...
    private void UseTeleport()
    {
        ...
        Console.WriteLine("[Pitu] Hooking run command");
    ...
    {
        Console.WriteLine("[Pitu] Register misc commands");
        ...
        Console.WriteLine("[Pitu] Finished registering misc commands");
    }
    private void UseResetScore()
    {
        Console.WriteLine("[Pitu] Register reset score command");
        
        var resetScore = _serviceProvider!.GetRequiredService<ResetScore>();
        RegisterConsoleCommandAttributeHandlers(resetScore);
        
        Console.WriteLine("[Pitu] Finished registering reset score command");
    }
    private void UseRageQuit()
    {
        Console.WriteLine("[Pitu] Register rage quit command");
        
        var rageQuit = _serviceProvider!.GetRequiredService<RageQuit>();
        RegisterConsoleCommandAttributeHandlers(rageQuit);
        
        Console.WriteLine("[Pitu] Finished registering rage quit command");
    }
    private void UseFriendlyFireRestrict()
    {
        Console.WriteLine("[Pitu] Register friendly fire listeners");
        ...
        Console.WriteLine("[Pitu] Finished registering friendly fire listeners");
    }
    private void UseRapidFireRestrict()
    {
        Console.WriteLine("[Pitu] Register rapid fire listeners");
        ...
        Console.WriteLine("[Pitu] Finished registering rapid fire listeners");
    }
    private void UseWeaponRestrict()
    {
        Console.WriteLine("[Pitu] Register weapon restriction listeners");
        ...
        RegisterEventHandler<EventPlayerTeam>(weaponRestrict.OnPlayerTeam);
        VirtualFunctions.CCSPlayer_WeaponServices_CanUseFunc.Hook(weaponRestrict.OnWeaponCanUse, HookMode.Pre);
        
        Console.WriteLine("[Pitu] Finished registering weapon restriction listeners");
    }
    ...
    public override void Unload(bool hotReload)
    {
        ...
        Console.WriteLine("[Pitu] Unregistering custom votes");
